...
exec("systemctl restart isc-dhcp-server", $output, $return_var);
if ($return_var != 0) {
    echo "Erreur lors du redémarrage du service DHCP : " . implode("\n", $output) . "\n";
} else {
    echo "Service DHCP redémarré avec succès.\n";
}
